...
public class Obstacle extends PuzzleModule{
	
	public Obstacle(String name, String desc, String puzzleType, String solution, int attemptsToSolve, boolean solved) {
